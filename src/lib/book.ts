...
export const book = [
  [
    "e1def1",
    {
      text: {
        en: ``,
        es: `Por causa de sí entiendo aquello cuya esencia implica la existencia, o, lo que es lo mismo, aquello cuya naturaleza sólo puede concebirse como existente.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1def2",
    {
      text: {
        en: ``,
        es: `Se llama finita en su género aquella cosa que puede, ser limitada por otra de su misma naturaleza. Por ejemplo, se dice que es finito un cuerpo porque concebimos siempre otro mayor. De igual modo, un pensamiento es limitado por otro pensamiento. Pero un cuerpo no es limitado por un pensamiento, ni un pensamiento por un cuerpo.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1def3",
    {
      text: {
        en: ``,
        es: `Por substancia entiendo aquello que es en sí y se concibe por sí, esto es, aquello cuyo concepto, para formarse, no precisa del concepto de otra cosa.
...
`,
  ...
  [
    "e1def4",
    {
      text: {
        en: ``,
        es: `Por atributo entiendo aquello que el entendimiento percibe de una substancia como constitutivo de la esencia de la misma.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1def5",
    {
      text: {
        en: ``,
        es: `Por modo entiendo las afecciones de una substancia, o sea, aquello que es en otra cosa, por medio de la cual es también concebido.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1def7",
    {
      text: {
        en: ``,
        es: `Se llama libre a aquella cosa que existe en virtud de la sola necesidad de su naturaleza y es determinada por sí sola a obrar; y necesaria, o mejor compelida, a la que es determinada por otra cosa a existir y operar, de cierta y determinada manera.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1ax1",
    {
      text: {
        en: ``,
        es: `Todo lo que es, o es en sí, o en otra cosa.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1ax2",
    {
      text: {
        en: ``,
        es: `Lo que no puede concebirse por medio de otra cosa, debe concebirse por sí.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1ax3",
    {
      text: {
        en: ``,
        es: `De una determinada causa dada se sigue necesariamente un efecto, y, por el contrario, si no se da causa alguna determinada, es imposible que un efecto se siga.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1ax4",
    {
      text: {
        en: ``,
        es: `El conocimiento del efecto depende del conocimiento de la causa, y lo implica.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1ax5",
    {
      text: {
        en: ``,
        es: `Las cosas que no tienen nada en común una con otra, tampoco pueden entenderse una por otra, esto es, el concepto de una de ellas no implica el concepto de la otra.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1ax6",
    {
      text: {
        en: ``,
        es: `Una idea verdadera debe ser conforme a lo ideado por ella.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1ax7",
    {
      text: {
        en: ``,
        es: `La esencia de todo lo que puede concebirse como no existente no implica la existencia.`,
        la: ``,
      },
      proof: [],
    },
  ...
  [
    "e1p1",
    {
      text: {
        en: ``,
        es: `Una substancia es anterior, por naturaleza, a sus afecciones. Demostración: Es evidente por las Definiciones 3 y 5.`,
        la: ``,
      },
      proof: ["e1def3", "e1def5"],
    },
  ...
  [
    "e1p2",
    {
      text: {
        en: ``,
        es: `Dos substancias que tienen atributos distintos no tienen nada en común entre sí. Demostración: Es evidente por la Definición 3. En efecto: cada una debe ser en sí y concebirse por sí, esto es, el concepto de una no implica el concepto de la otra`,
        la: ``,
      },
      proof: ["e1def3"],
    },
  ...
  [
    "e1p3",
    {
      text: {
        en: ``,
        es: `No puede una cosa ser causa de otra, si entre sí nada tienen en común. Demostración: Si nada común tienen una con otra, entonces (por el Axioma 5) no pueden entenderse una por otra, y, por tanto (por el Axioma 4), una no puede ser causa de la otra. Quod erat demonstrandum (en lo sucesivo Q.E.D.).`,
        la: ``,
      },
      proof: ["e1ax5", "e1ax4"],
    },
  ...
  [
    "e1p4",
    {
      text: {
        en: ``,
        es: `Dos o más cosas distintas se distinguen entre sí, o por la diversidad de los atributos de las substancias o por la diversidad de las afecciones de las mismas. Demostración: Todo lo que es, o es en sí, o en otra cosa (por el Axioma 1), esto es (por las Definiciones 3 y 5), fuera del entendimiento nada se da excepto las substancias y sus afecciones. Por consiguiente, nada hay fuera del entendimiento que sea apto para distinguir varias cosas entre sí, salvo las substancias o, lo que es lo mismo (por la Definición 4), sus atributos y sus afecciones. Q.E.D.`,
        la: ``,
      },
      proof: ["e1ax1", "e1def3", "e1def5", "e1def4"],
    },
  ],
  [
    "e1p5",
  ...
  [
    "e1p6",
    {
      text: {
        en: ``,
        es: `Una substancia no puede ser producida por otra substancia. Demostración: En la naturaleza no puede haber dos substancias con el mismo atributo (por la Proposición anterior), esto es (por la Proposición 2), no puede haber dos substancias que tengan algo de común entre sí. De manera que (por la Proposición 3) una no puede ser causa de la otra, o sea, no puede ser producida por la otra. Q.E.D.`,
        la: ``,
      },
      proof: ["e1p5", "e1p2", "e1p3"],
    },
  ],
  [
    "e1p6cor",
    {
      text: {
        en: ``,
        es: `Corolario: Se sigue de aquí que una substancia no puede ser producida por otra cosa. Pues nada hay en la naturaleza excepto las substancias y sus afecciones, como es evidente por el Axioma 1 y las Definiciones 3 y 5. Pero como (por la Proposición anterior) una substancia no puede ser producida por otra substancia, entonces una substancia no puede, en términos absolutos, ser producida por otra cosa. Q.E.D. De otra manera: Se demuestra ésta más fácilmente todavía en virtud del absurdo de su contradictoria. Pues, si la substancia pudiese ser producida por otra cosa, su conocimiento debería depender del conocimiento de su causa (por el Axioma 4); y, por lo tanto (según la Definición 3), no sería una substancia.`,
        la: ``,
      },
  ...
  [
    "e1p7",
    {
      text: {
        en: ``,
        es: `A la naturaleza de una substancia pertenece el existir. Demostración: Una substancia no puede ser producida por otra cosa (por el Corolario de la Proposición anterior); será, por tanto, causa de sí, es decir (por la Definición 1), que su esencia implica necesariamente la existencia, o sea, que a su naturaleza pertenece el existir. Q.E.D.`,
        la: ``,
      },
      proof: ["e1p6cor", "e1def1"],
    },
  ],
  [
    "e1p8",
  ...
  [
    "e1p8exp1",
    {
      text: {
        en: ``,
        es: `Escolio 1: Como el ser finito es realmente una negación parcial, y el ser infinito una afirmación absoluta de la existencia de cualquier naturaleza, se sigue, pues, de la sola Proposición 7, que toda substancia debe ser infinita.`,
        la: ``,
      },
  ...
  [
    "e1p9",
    {
      text: {
        en: ``,
        es: `Cuanto más realidad o ser tiene una cosa, tantos más atributos le competen. Demostración: Es evidente por la Definición 4.`,
        la: ``,
      },
      proof: ["e1def4"],
    },
  ...
  [
    "e1p10",
    {
      text: {
        en: ``,
        es: `Cada atributo de una misma substancia debe concebirse por sí. Demostración: Un atributo es, en efecto, lo que el entendimiento percibe de una substancia como constitutivo de la esencia de la misma (por la Definición 4); por tanto (por la Definición 3), debe concebirse por sí. Q.E.D.`,
        la: ``,
      },
      proof: ["e1def4", "e1def3"],
    },
  ...
  [
    "e1p13",
    {
      text: {
        en: ``,
        es: `Una substancia absolutamente infinita es indivisible. Demostración: En efecto: si fuese divisible, las partes en las que se dividiría, o bien conservarían la naturaleza de una substancia absolutamente infinita, o bien no. Si lo primero, habría, consiguientemente, varias substancias de la misma naturaleza, lo que (por la Proposición 5) es absurdo. Si se admite lo segundo, una substancia absolutamente infinita podría (como vimos antes) dejar de ser, lo que (por la Proposición 11) es también absurdo.`,
        la: ``,
      },
      proof: ["e1p5", "e1p12", "e1p11"],
    },
  ],
  [
    "e1p13cor",
    {
      text: {
        en: ``,
        es: `Corolario: De aquí se sigue que ninguna substancia y, consiguientemente, ninguna substancia corpórea, en cuanto substancia, es divisible.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
      proof: ["e1p13"],
  ...
  [
    "e1p14cor1",
    {
      text: {
        en: ``,
        es: `Corolario I: De aquí se sigue muy claramente: primero, que Dios es único, esto es (por la Definición 6), que en la naturaleza no hay sino una sola substancia, y que ésta es absolutamente infinita, como ya indicamos en el Escolio de la Proposición 10.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
  ...
  [
    "e1p14cor2",
    {
      text: {
        en: ``,
        es: `Corolario II: Se sigue: segundo, que la cosa extensa y la cosa pensante, o bien son atributos de Dios, o bien (por el Axioma 1) afecciones de los atributos de Dios.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
      proof: ["e1p14", "e1ax1"],
  ...
  [
    "e1p16cor1",
    {
      text: {
        en: ``,
        es: `Corolario I: De aquí se sigue: primero, que Dios es causa eficiente de todas las cosas que pueden caer bajo un entendimiento infinito.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
      proof: ["e1p16"],
  ...
  [
    "e1p16cor2",
    {
      text: {
        en: ``,
        es: `Corolario II: Se sigue: segundo, que Dios es causa por sí y no por accidente.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
      proof: ["e1p16"],
  ...
  [
    "e1p16cor3",
    {
      text: {
        en: ``,
        es: `Corolario III: Se sigue: tercero, que Dios es absolutamente causa primera.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
      proof: ["e1p16"],
  ...
  [
    "e1p17cor1",
    {
      text: {
        en: ``,
        es: `Corolario I: De aquí se sigue: primero, que no hay ninguna causa que, extrínseca O intrínsecamente, incite a Dios a obrar, a no ser la perfección de su misma naturaleza.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
      proof: ["e1p17"],
  ...
  [
    "e1p20cor1",
    {
      text: {
        en: ``,
        es: `Corolario 1: Se sigue de aquí: primero, que la existencia de Dios es, como su esencia, una verdad eterna.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
      proof: ["e1p20"],
  ...
  [
    "e1p22",
    {
      text: {
        en: ``,
        es: `Todo lo que se sigue a partir de un atributo de Dios, en cuanto afectado de una modificación tal que en virtud de dicho atributo existe necesariamente y es infinita, debe también existir necesariamente y ser infinito. Demostración: La demostración a esta Proposición procede de la misma manera que la demostración de la anterior.`,
        la: ``,
      },
  ...
  [
    "e1p24",
    {
      text: {
        en: ``,
        es: `La esencia de las cosas producidas por Dios no implica la existencia. Demostración: Es evidente por la Definición 1. En efecto, aquello cuya naturaleza (a saber: considerada en sí) implica la existencia es causa de sí, y existe en virtud de la sola necesidad de su naturaleza.`,
        la: ``,
      },
      proof: ["e1def1"],
    },
  ...
  [
    "e1p25",
    {
      text: {
        en: ``,
        es: `Dios no es sólo causa eficiente de la existencia de las cosas, sino también de su esencia. Demostración: Si negáis eso, entonces Dios no es causa de la esencia de las cosas, y de esta suerte (por el Axioma, 4) puede concebirse sin Dios la esencia de las cosas: pero eso (por la Proposición 15) es absurdo. Luego Dios es causa también de la esencia de las cosas. Q.E.D.`,
        la: ``,
      },
      // note: e1p25exp says that e1p16 is an
  ...
  [
    "e1p25exp",
    {
      text: {
        en: ``,
        es: `Escolio: Esta Proposición deriva más claramente de la Proposición 16. En efecto, se sigue de ésta que, dada la naturaleza divina, de ella deben concluirse necesariamente tanto la esencia como la existencia de las cosas; en una palabra: en el mismo sentido en que se dice que Dios es causa de sí, debe decirse también que es causa de todas las cosas, lo que constará aún más claramente por el siguiente Corolario.`,
        la: ``,
      },
      // "explanation" must include parent as proof
  ...
  [
    "e1p25cor",
    {
      text: {
        en: ``,
        es: `Corolario: Las cosas particulares no son sino afecciones de los atributos de Dios, o sea, modos por los cuales los atributos de Dios se expresan de cierta y determinada manera. La demostración de esto es evidente por la Proposición 15 y la Definición 5.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
  ...
  [
    "e1p27",
    {
      text: {
        en: ``,
        es: `Una cosa que ha sido determinada por Dios a obrar algo, no puede convenirse a sí misma en indeterminada. Demostración: Esta Proposición es evidente por el Axioma tercero.`,
        la: ``,
      },
      proof: ["e1ax3"],
    },
  ...
  [
    "e1p29",
    {
      text: {
        en: ``,
        es: `En la naturaleza no hay nada contingente, sino que, en virtud de la necesidad de la naturaleza divina, todo está determinado a existir y obrar de cierta manera. Demostración: Todo lo que es, es en Dios (por la Proposición 15): pero Dios no puede ser llamado cosa contingente. Pues (por la Proposición 11) existe necesariamente, y no contingentemente. Además, los modos de la naturaleza divina se han seguido de ella también de un modo necesario, no contingente (por la Proposición 16), y ello, ya sea en cuanto la naturaleza divina es considerada en términos absolutos (por la Proposición 21), ya sea en cuanto se la considera como determinada a obrar de cierta manera (por la Proposición 27). Además, Dios es causa de estos modos no sólo en cuanto simplemente existen (por el Corolario de la Proposición 24), sino también (por la Proposición 26) en cuanto se los considera como determinados a obrar algo. Pues, si no son determinados por Dios (por la misma Proposición), es imposible, y no contingente, que se determinen a sí mismos; y, al contrario (por la Proposición 27), si son determinados por Dios, es imposible, y no contingente, que se conviertan a sí mismos en indeterminados. Por lo cual, todas las cosas están determinadas, en virtud de la necesidad de la naturaleza divina, no sólo a existir, sino también a existir y obrar de cierta manera, y no hay nada contingente. Q.E.D.`,
        la: ``,
      },
      proof: ["e1p15", "e1p11", "e1p16", "e1p21", "e1p27", "e1p24cor", "e1p26"],
    },
  ],
  [
    "e1p29exp",
  ...
  [
    "e1p31",
    {
      text: {
        en: ``,
        es: `El entendimiento en acto, sea finito o infinito, así como la voluntad, el deseo, el amor, etc., deben ser referidos a la Naturaleza naturada, y no a la naturante. Demostración: En efecto (como es notorio por sí), no entendemos por «entendimiento» el pensamiento en términos absolutos, sino sólo un cierto modo del pensar, que difiere de otros modos como el deseo, el amor, etc. y que, por tanto, debe ser concebido por medio del pensamiento tomado en términos absolutos, es decir (por la Proposición 15 y la Definición 6), debe concebirse por medio de un atributo de Dios que exprese la eterna e infinita esencia del pensamiento de tal modo que sin él no pueda ser ni ser concebido, y por ello (por el Escolio de la Proposición 29) debe ser referido a la Naturaleza naturada, como también los demás modos del pensar, y no a la naturante. Q.E.D.`,
        la: ``,
      },
      proof: ["e1def5", "e1p15", "e1def6", "e1p29exp"],
    },
  ],
  [
    "e1p31exp",
  ...
  [
    "e1p32",
    {
      text: {
        en: ``,
        es: `La voluntad no puede llamarse causa libre, sino sólo causa necesaria. Demostración: La voluntad, como el entendimiento, es sólo un cierto modo del pensar, y así (por la Proposición 28) ninguna volición puede existir ni ser determinada a obrar si no es determinada por otra causa, y ésta a su vez por otra, y así hasta el infinito. Pues si se supone una voluntad infinita, debe también ser determinada por Dios a existir y obrar, no en cuanto Dios es substancia absolutamente infinita, sino en cuanto tiene un atributo que expresa la esencia infinita y eterna del pensamiento (por la Proposición 23). Concíbasela, pues, del modo que sea, ya como finita, ya como infinita, requiere una causa en cuya virtud sea determinada a existir y obrar; y así (por la Definición 7) mo puede llamarse causa libre, sino sólo necesaria o compelida. Q.E.D.`,
        la: ``,
      },
  ...
  [
    "e1p32cor1",
    {
      text: {
        en: ``,
        es: `Corolario I: Se sigue de aquí: primero, que Dios no obra en virtud de la libertad de su voluntad.`,
        la: ``,
      },
      // "corollary" must include parent as proof:
      proof: ["e1p32"],
  ...
  [
    "e1p34",
    {
      text: {
        en: ``,
        es: `La potencia de Dios es su esencia misma. Demostración: En efecto, de la sola necesidad de la esencia de Dios se sigue que Dios es causa de sí (por la Proposición 11) y (por la Proposición 16 y su Corolario) de todas las cosas. Luego la potencia de Dios, por la cual son y obran él mismo y todas las cosas, es su esencia misma. Q.E.D.`,
        la: ``,
      },
      // e1p16 has multiple corollaries, but here Spinoza just says "per propositionem 16 ejusque corollarium",
      // as in the singular form, so here I assume he meant all three as a single thing; i.e., as a group. This
      // could also sugest that at some point it was just one that he added to or split up, and forgot to fix here.
  ...
  [
    "e1p35",
    {
      text: {
        en: ``,
        es: `Todo lo que concebimos que está en la potestad de Dios, es necesariamente. Demostración: En efecto, todo lo que está en la potestad de Dios debe (por la Proposición anterior) estar comprendido en su esencia de tal manera que se siga necesariamente de ella, y es, por tanto, necesariamente. Q.E.D.`,
        la: ``,
      },
      proof: ["e1p34"],
    },
  ...
  [
    "e2p2",
    {
      ...
      // proves this one, but I also include the "explanation" for the sake of completeness:
      proof: ["e2p1", "e2p1exp"],
    },
  ],
  [
  ...
  [
    "e2p40exp1",
    {
      ...
      // "explanation" must include parent as proof
      proof: ["e2p40", "e2p17exp", "e2p17cor", "e2p18"],
    },
  ],
  [
    "e2p40exp2",
    {
      ...
      // "explanation" must include parent as proof
      proof: ["e2p40", "e2p29cor", "e2p18exp", "e2p38cor", "e2p39", "e2p39cor"],
  ...
  [
    "e2p43exp",
    {
      ...
      // "explanation" must include parent as proof
      proof: ["e2p43", "e2p21exp", "e2p35", "e2p19", "e2p35exp", "e2p11cor"],
    },
  ],
  [
    "e2p44",
  ...
  [
    "e2p47exp",
    {
      ...
      // points out e2p40exp(2), not just any exp;
      // "explanation" must include parent as proof
      proof: ["e2p47", "e2p40exp2"],
    },
  ],
  [
    "e2p48",
  ...
  [
    "e2p48exp",
    {
      ...
      // Curiously, this "explanation" points to
